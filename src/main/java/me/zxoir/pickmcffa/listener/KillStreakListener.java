...
public class KillStreakListener implements Listener {
    @Getter
    private static final ConcurrentHashMap<User, KillStreak> killStreak = new ConcurrentHashMap<>();
    @Getter
    private static final ConcurrentHashMap<UUID, BukkitTask> bountyList = new ConcurrentHashMap<>();
    @Getter
